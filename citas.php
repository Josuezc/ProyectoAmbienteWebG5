...
<div class="container">
  <div class="row">
    <div class="col">
    <label for="busquedaId">Búscar cita por identificación</label>

    </div>
    <div class="col-4">
    <input type="text" id="busquedaId" name="busquedaId" placeholder="Ingrese la identificación">
    </div>
    <div class="col">
    <button type="submit" class="btn btn-success" id="buscarId">Buscar</button>    
    </div>
    <div class="col">    
